...
export type ColorToken =
  ...
  | 'colorPalette.strong'
  | 'colorPalette.frame.background'
  | 'colorPalette.background'
  | 'colorPalette.frame.border'
  | 'colorPalette.border'
  | 'colorPalette.frame.borderHover'
  | 'colorPalette.borderHover'
  | 'colorPalette.active'
  | 'colorPalette.activeHover';
...
export type SpacingToken =
  ...
  | '4.5'
  | '5.5'
  | 'component.list.rowBlock'
  | 'component.list.rowBlockDense'
  | 'component.media.frame'
  | 'component.media.caption'
  | 'component.media.meta'
  | 'layout.inline'
  | 'layout.compact'
  | 'layout.group'
  | 'layout.section'
...
export type RadiusToken =
  'xs' | 'lg' | 'xl' | '2xl' | '3xl' | '4xl' | 'full' | 'none' | 'sm' | 'md' | 'pill';
...
export type DurationToken =
  'fastest' | 'faster' | 'slower' | 'slowest' | 'fast' | 'normal' | 'slow';
