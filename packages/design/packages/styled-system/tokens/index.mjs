const tokens = {
  ...
  'fonts.bgmSans': {
    value:
      '"SF Pro SC", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei UI", "Noto Sans CJK SC", "Noto Sans JP", "Segoe UI", Arial, sans-serif',
    variable: 'var(--fonts-bgm-sans)',
  },
  'fonts.mono': {
    value:
      'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace, SFMono-Regular, Consolas, Liberation Mono, monospace',
