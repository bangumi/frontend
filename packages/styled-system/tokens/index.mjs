const tokens = {
  ...
  "colors.bgmPrimary": {
    "value": "#F09199",
    "variable": "var(--colors-bgm-primary)"
  },
  "colors.bgmBlue": {
    "value": "#369CF8",
    "variable": "var(--colors-bgm-blue)"
  },
  "colors.bgmLink": {
    "value": "#0084B4",
    "variable": "var(--colors-bgm-link)"
  },
  "colors.bgmLinkHover": {
    "value": "#02A3FB",
    "variable": "var(--colors-bgm-link-hover)"
  },
  "colors.bgmNavBg": {
    "value": "#FCFCFC",
    "variable": "var(--colors-bgm-nav-bg)"
  },
  "colors.bgmNavBgEnd": {
    "value": "#FAFAF9",
    "variable": "var(--colors-bgm-nav-bg-end)"
  },
  "colors.bgmNavBorder": {
    "value": "#DDDDDD",
    "variable": "var(--colors-bgm-nav-border)"
  },
  "colors.bgmNavText": {
    "value": "#777777",
    "variable": "var(--colors-bgm-nav-text)"
  },
  "colors.bgmNavMenuBgStart": {
    "value": "#F5F5F5",
    "variable": "var(--colors-bgm-nav-menu-bg-start)"
  },
  "colors.bgmNavMenuBgEnd": {
    "value": "#F1F1F1",
    "variable": "var(--colors-bgm-nav-menu-bg-end)"
  },
  "colors.bgmDropBg": {
    "value": "rgba(254, 254, 254, 0.9)",
    "variable": "var(--colors-bgm-drop-bg)"
  },
  "colors.bgmDropBorder": {
    "value": "#EEEEEE",
    "variable": "var(--colors-bgm-drop-border)"
  },
  "colors.bgmTextTip": {
    "value": "#999999",
    "variable": "var(--colors-bgm-text-tip)"
  },
  "colors.bgmFooterBg": {
    "value": "#F8F8F8",
    "variable": "var(--colors-bgm-footer-bg)"
  },
  "colors.bgmFooterText": {
    "value": "#AAAAAA",
    "variable": "var(--colors-bgm-footer-text)"
  },
  "colors.bgmFooterLink": {
    "value": "#777777",
    "variable": "var(--colors-bgm-footer-link)"
  },
  "colors.bgmFooterLinkHover": {
    "value": "#333333",
    "variable": "var(--colors-bgm-footer-link-hover)"
  },
  "colors.bgmBorder": {
    "value": "#EEEEEE",
    "variable": "var(--colors-bgm-border)"
  },
  "colors.bgmBorderMedium": {
    "value": "#CCCCCC",
    "variable": "var(--colors-bgm-border-medium)"
  },
  "breakpoints.sm": {
    "value": "640px",
