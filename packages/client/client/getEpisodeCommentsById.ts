...
export async function execute(episode_id: number): Promise<Res> {
 ...
 */
export async function executeX(episode_id: number): Promise<ResX['data']> {
...
export function swrKey(episode_id: number): string {
  return `getEpisodeCommentsById-${episode_id}`;
}
